HOW WELL DO YOU KNOW ME? - offline installable web app
======================================================
Files
  index.html      app shell
  style.css       styles
  app.js          game logic + 97 questions + service-worker registration
...
Your data
  Names, history and any game in progress are saved only in this browser on this device.
